...
import { requireAuth, requireAdmin, requireFinanceAdmin, requireSuperAdmin } from "../middlewares/auth";
...
router.post("/cashout/request", requireAuth, async (req, res): Promise<void> => {
...
router.post("/cashout/stripe", requireAuth, async (req, res): Promise<void> => {
