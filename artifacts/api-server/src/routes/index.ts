...
import adminStripeTransactionsRouter from "./adminStripeTransactions";
import walletRouter from "./wallet";
import fintechRouter from "./fintech";
import cashoutRouter from "./cashout";
import haitiMoneyRouter from "./haiti-money";
...
import promoPurchaseCommissionsRouter from "./promoPurchaseCommissions";
import fraudRouter from "./fraud";
import shippingRouter from "./shipping";
import trackingCenterRouter from "./trackingCenter";
...
router.use(adminStripeTransactionsRouter);
router.use(walletRouter);
router.use(haitiMoneyRouter);
...
router.use(trackingCenterRouter);
router.use(shippingRouter);
router.use(flexCardRouter);
router.use(referralsRouter);
router.use(promoPurchaseCommissionsRouter);
router.use(tvRouter);
router.use(musicRouter);
router.use(storeManagerRouter);
