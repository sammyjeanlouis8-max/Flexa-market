...
import {
  ...
  Heart, Star, Trophy, ChevronRight,
} from "lucide-react";
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0 space-y-2">
                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        ...
                        <span className="text-[10px] text-muted-foreground ml-auto">
                          {new Date(d.createdAt).toLocaleDateString("fr-HT", { day: "2-digit", month: "short", hour: "2-digit", minute: "2-digit" })}
                        </span>
                      </div>
                    ...
                    <div className="text-right shrink-0 space-y-0.5">
                      {d.feeUsd != null && d.feeUsd > 0 ? (
                        <>
                          <p className="font-black text-base text-primary">${d.feeUsd.toFixed(2)}</p>
                        ...
                        <>
                          <p className="font-black text-base text-primary">${d.driverEarnings.toFixed(2)}</p>
