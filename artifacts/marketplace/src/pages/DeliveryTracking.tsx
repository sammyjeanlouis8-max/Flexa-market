...
const STEPS = ["waiting", "driver_assigned", "arrived_pickup", "picked_up", "on_the_way", "arrived", "delivered"];
const STEP_ICONS = [Clock, User, MapPin, Package, Truck, MapPin, CheckCircle];
