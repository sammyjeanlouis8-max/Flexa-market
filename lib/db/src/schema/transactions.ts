...
export const transactionsTable = pgTable("transactions", {
  ...
  stripeVerifiedAmountCents: integer("stripe_verified_amount_cents"),
  stripeVerifiedStatus: text("stripe_verified_status"),
  stripeVerifiedCurrency: text("stripe_verified_currency"),
  stripeVerifiedAt: timestamp("stripe_verified_at", { withTimezone: true }),
