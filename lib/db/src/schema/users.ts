...
export const usersTable = pgTable("users", {
  ...
  // Flex Card debt restriction — blocks ONLY outgoing money (spend/transfer/
  // withdraw/buy). Account stays usable for login, selling, and receiving money.
  ...
  managedSellerId: integer("managed_seller_id").references((): AnyPgColumn => usersTable.id),
